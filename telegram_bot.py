...
API_TOKEN = "5302029732:AAENrrdfY1-NprXCUd26UA1vbpXy3VUumk8"
...
async def send_photos(message):
    try:
        ...
        photo1 = InputMediaPhoto(open(img1, "rb"), caption="Unas")
